...
Asena.addCommand({pattern: 'ban ?(.*)', fromMe: true, deleteCommand: false, onlyGroup: true, desc: Lang.BAN_DESC}, (async (message, match) => {  
...
Asena.addCommand({pattern: 'add(?: |$)(.*)', fromMe: true, deleteCommand: false, onlyGroup: true, desc: Lang.ADD_DESC, usage: '.add 905xxxxxxxxx'}, (async (message, match) => {  
    var im = await checkImAdmin(message);
    if (!im) return await message.sendMessage(Lang.IM_NOT_ADMIN);
...
Asena.addCommand({pattern: 'promote ?(.*)', fromMe: true, deleteCommand: false, onlyGroup: true, desc: Lang.PROMOTE_DESC}, (async (message, match) => {    
    var im = await checkImAdmin(message);
    if (!im) return await message.sendMessage(Lang.IM_NOT_ADMIN);
...
Asena.addCommand({pattern: 'demote ?(.*)', fromMe: true, deleteCommand: false, onlyGroup: true, desc: Lang.DEMOTE_DESC}, (async (message, match) => {    
    var im = await checkImAdmin(message);
    if (!im) return await message.sendMessage(Lang.IM_NOT_ADMIN);
...
Asena.addCommand({pattern: 'mute ?(.*)', fromMe: true, deleteCommand: false, onlyGroup: true, desc: Lang.MUTE_DESC}, (async (message, match) => {    
    var im = await checkImAdmin(message);
    if (!im) return await message.sendMessage(Lang.IM_NOT_ADMIN);
...
Asena.addCommand({pattern: 'unmute ?(.*)', fromMe: true, deleteCommand: false, onlyGroup: true, desc: Lang.UNMUTE_DESC}, (async (message, match) => {    
    var im = await checkImAdmin(message);
    if (!im) return await message.sendMessage(Lang.IM_NOT_ADMIN);
...
Asena.addCommand({pattern: 'invite ?(.*)', fromMe: true, deleteCommand: false, onlyGroup: true, desc: Lang.INVITE_DESC}, (async (message, match) => {    
    var im = await checkImAdmin(message);
    if (!im) return await message.sendMessage(Lang.IM_NOT_ADMIN);
